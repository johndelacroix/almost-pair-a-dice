...
* Install/configure MVN in your workstation in order to run this Spring Boot app 
...
* The log should have this at the end to confirm that Spring Boot app is already up with no issues:
```
...
Resources folder(`src->main->resources`) contains folders for storing binary files, data files, image files, properties files, etc. which will be utilized by the Spring Boot application.
